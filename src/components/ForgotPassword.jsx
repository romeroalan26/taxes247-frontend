        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 items-start justify-center">
          ...
          >
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-red-600 to-red-700 rounded-t-2xl p-6 sm:p-8 text-white"
            >
            ...
            <motion.div
              ...
              className="bg-white rounded-b-2xl shadow-lg p-6 sm:p-8"
            >
              {/* Mensajes de Estado */}
              <AnimatePresence>
                {message && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className="mb-4 sm:mb-6 p-4 bg-green-50 border border-green-200 rounded-xl flex items-center gap-3"
                  >
                ...
                {error && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className="mb-4 sm:mb-6 p-4 bg-red-50 border border-red-200 rounded-xl flex items-center gap-3"
                  >
